...
<p>The installation process is done. To move on and start using Penny you must first disable the controller used for the installation phase.
...
<p>Have fun with your Penny installation and let me know what you think about it!</p>

<p class='info'>The install controller is currently <strong><?=$status?></strong>.</p>

<p>
<a href='<?=create_url(null, 'step4')?>'>&laquo; Back</a>&nbsp;&nbsp;&nbsp;
<a href='<?=create_url(null)?>'>Check to see if the install-controller is disabled (you will leave this page if it is)...</a>&nbsp;&nbsp;&nbsp;
</p>
