...
<?php if($magic_quotes): ?>
<p class='error'>You have magic quotes enabled on this server. Penny has NOT been tested on a server with safe mode enabled.</p>
<?php else: ?>
...
<?php if($problems): ?>
<p class='error'>Your environment does not fully match the need of Penny. You may try to correct the issues or try anyway. But do not say I did not warn you.</p>
<?php else: ?>
<p class='success'><b>Nice!</b> It seems like this is an environment where Penny may enjoy herself.</p>
<?php endif; ?>


<p>
<a href='<?=create_url(null, 'index')?>'>&laquo; Back</a>&nbsp;&nbsp;&nbsp;
<a href='<?=create_url(null, 'step1')?>'>Reload and check again</a>&nbsp;&nbsp;&nbsp;
